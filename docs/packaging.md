...
- `quilt-core-0.2.3.tgz`
- `quilt-vanilla-0.2.3.tgz`
- `quilt-react-0.2.3.tgz`
...
```sh
npm install ./vendor/quilt/quilt-core-0.2.3.tgz \
  ./vendor/quilt/quilt-vanilla-0.2.3.tgz
```
...
npm install ./vendor/quilt/quilt-core-0.2.3.tgz \
  ./vendor/quilt/quilt-vanilla-0.2.3.tgz \
  ./vendor/quilt/quilt-react-0.2.3.tgz
```
...
{
  "dependencies": {
    "quilt-core": "file:vendor/quilt/quilt-core-0.2.3.tgz",
    "quilt-vanilla": "file:vendor/quilt/quilt-vanilla-0.2.3.tgz"
  }
}
```
