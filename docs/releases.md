...
1. Create a branch and run `npm run release:version -- 0.3.0` (substitute the next version).
2. Add a `## 0.3.0` entry to `CHANGELOG.md`. Review the version and internal dependency changes, then merge a pull request after CI passes.
